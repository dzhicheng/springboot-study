package com.dongzhic.druid.config;

import com.alibaba.druid.pool.DruidDataSource;
import com.alibaba.druid.support.http.StatViewServlet;
import com.alibaba.druid.support.http.WebStatFilter;
import com.dongzhic.dynamic.datasource.DynamicDataSource;
import com.dongzhic.dynamic.datasource.DynamicDataSourceContextHolder;
import lombok.Data;
...
//    @Bean(destroyMethod = "close",initMethod = "init")
    ...
    public ServletRegistrationBean druidStateViewServlet(){
        ...
        //添加ip黑名单
        servletRegistrationBean.addInitParameter("deny","192.168.30.173");
        //登录查看信息的账号密码
